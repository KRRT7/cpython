...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_SUBTRACT_INT64] = HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_SUBTRACT_INT64] = {
        .best = { 2, 2, 2, 2 },
        .entries = {
            { -1, -1, -1 },
            { -1, -1, -1 },
            { 1, 2, _BINARY_OP_SUBTRACT_INT64_r21 },
            { -1, -1, -1 },
        },
    },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_SUBTRACT_INT64_r21] = _BINARY_OP_SUBTRACT_INT64,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_SUBTRACT_INT64] = "_BINARY_OP_SUBTRACT_INT64",
    [_BINARY_OP_SUBTRACT_INT64_r21] = "_BINARY_OP_SUBTRACT_INT64_r21",
...
int _PyUop_num_popped(int opcode, int oparg)
{
    switch(opcode) {
        ...
        case _BINARY_OP_SUBTRACT_INT:
            return 2;
        case _BINARY_OP_SUBTRACT_INT64:
            return 2;
