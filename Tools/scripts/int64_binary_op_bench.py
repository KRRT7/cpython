...
CASES = (
    ("compact add", "a=1; b=2", "a+b"),
    ("wide add", "a=10000000000; b=1", "a+b"),
    ("wide sub", "a=10000000000; b=1", "a-b"),
)
...
def main() -> int:
    ...
    print()
    print(f"{'case':<14}{'baseline ns/op':>16}{'candidate ns/op':>18}{'delta':>14}{'delta %':>10}")
    ...
    for name, setup, stmt in CASES:
        ...
        print(f"{name:<14}{base:>16.2f}{cand:>18.2f}{delta:>14.2f}{pct:>9.2f}%")
